...
import { Moon, Sun, Mail, Phone, TriangleAlert } from 'lucide-react'
...
export default function Footer() {
	...
	return (
		<>
			...
			<div className="px-4 py-3 text-center bg-amber-100/80 dark:bg-amber-900/80 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-800 backdrop-blur-sm">
				<p className="text-sm">
					<TriangleAlert
						...
						aria-hidden="true"
					/>
					Zaptronic is not a real e-commerce store. This is only for demonstration
					purposes.
				</p>
			</div>
		</>
